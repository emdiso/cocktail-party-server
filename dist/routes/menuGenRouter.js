...
menuGenRouter.delete("/delete_menu", authUtils_1.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return psqlConnection_1.default.query(`DELETE FROM menus m WHERE m.id = ${menu_id} AND m.user_id = ${req.userId}`).then((result) => {
        return res.send("OK");
    }).catch(() => {
